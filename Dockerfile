...
COPY learning-service/gradle gradle
COPY learning-service/gradlew gradlew
COPY learning-service/build.gradle build.gradle
COPY learning-service/settings.gradle settings.gradle
